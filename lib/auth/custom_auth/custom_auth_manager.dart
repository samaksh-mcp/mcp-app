...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    missCallPayMerchantAppDuplicateAuthUserSubject.add(
      MissCallPayMerchantAppDuplicateAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MissCallPayMerchantAppDuplicateAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MissCallPayMerchantAppDuplicateAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MissCallPayMerchantAppDuplicateAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    missCallPayMerchantAppDuplicateAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
MissCallPayMerchantAppDuplicateAuthUser? currentUser;
