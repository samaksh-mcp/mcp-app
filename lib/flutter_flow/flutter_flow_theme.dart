...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF002EDC);
  late Color secondary = const Color(0x580BB74A);
  ...
  late Color success = const Color(0xFFE4F8EC);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFF6404E);
