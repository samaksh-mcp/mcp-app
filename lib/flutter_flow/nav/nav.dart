...
class AppStateNotifier extends ChangeNotifier {
  ...
  MissCallPayMerchantAppDuplicateAuthUser? initialUser;
  MissCallPayMerchantAppDuplicateAuthUser? user;
  ...
  void update(MissCallPayMerchantAppDuplicateAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'DoneScreen',
          path: '/doneScreen',
          builder: (context, params) => const DoneScreenWidget(),
        ),
        FFRoute(
          name: 'ViewQRPage',
          path: '/viewQRPage',
          builder: (context, params) => const ViewQRPageWidget(),
        ),
        FFRoute(
          name: 'HomeScreen',
          path: '/homeScreen',
