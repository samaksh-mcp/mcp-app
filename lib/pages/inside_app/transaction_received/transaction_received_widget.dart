...
import 'transaction_received_model.dart';
export 'transaction_received_model.dart';

class TransactionReceivedWidget extends StatefulWidget {
  const TransactionReceivedWidget({
    super.key,
    required this.txn,
  });
  ...
  @override
  State<TransactionReceivedWidget> createState() =>
      _TransactionReceivedWidgetState();
}

class _TransactionReceivedWidgetState extends State<TransactionReceivedWidget>
    with TickerProviderStateMixin {
  late TransactionReceivedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TransactionReceivedModel());
                    ...
                    Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Align(
                            alignment: const AlignmentDirectional(0.0, 2.47),
                            child: SizedBox(
                              width: 100.0,
                              height: 100.0,
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 5.0, 0.0, 30.0),
                              child: Text(
                                'Received on ${functions.formatDate(TxnStruct.maybeFromMap(widget.txn!)!.completedAt, FFAppConstants.dateFormat)}',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
