...
import 'transaction_expired_model.dart';
export 'transaction_expired_model.dart';

class TransactionExpiredWidget extends StatefulWidget {
  const TransactionExpiredWidget({
    super.key,
    required this.txn,
  });
  ...
  @override
  State<TransactionExpiredWidget> createState() =>
      _TransactionExpiredWidgetState();
}

class _TransactionExpiredWidgetState extends State<TransactionExpiredWidget> {
  late TransactionExpiredModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TransactionExpiredModel());
                ...
                child: Padding(
                  ...
                  child: Stack(
                    children: [
                      ...
                      Align(
                        alignment: const AlignmentDirectional(0.0, 2.66),
                        child: SizedBox(
                          width: 100.0,
                          height: 100.0,
                  ...
                  children: [
                    ...
                    Builder(
                      builder: (context) {
                        ...
                        } else if (FFAppConstants.txnOtherCollectRequest ==
                            getJsonField(
                              widget.txn,
                              r'''$.txn_request''',
                            ).toString()) {
                    ...
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(0.0, 5.0, 0.0, 0.0),
                      child: Text(
                        'Expired on ${functions.formatDate(TxnStruct.maybeFromMap(widget.txn!)!.expirationDate, FFAppConstants.dateFormat)}',
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily:
                                  FlutterFlowTheme.of(context).bodyMediumFamily,
                              fontSize: 12.0,
