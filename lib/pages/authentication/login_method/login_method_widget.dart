          ...
          child: Form(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Align(
                    alignment: const AlignmentDirectional(-0.78, 0.0),
                    child: Text(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        if (FFAppState().checked == true) {
                          _model.allFieldsFilled = true;
                          if (_model.formKey.currentState == null ||
                              !_model.formKey.currentState!.validate()) {
                            safeSetState(() => _model.allFieldsFilled = false);
                            return;
                          }
                          shouldSetState = true;
                          ...
                          _model.checksum = actions.generateChecksum(
                            functions.jsonString(
                                _model.mobileNumTextController.text),
                          ...
                          _model.generatedOtp =
                            ...
                            mobileNum: _model.mobileNumTextController.text,
                          );
