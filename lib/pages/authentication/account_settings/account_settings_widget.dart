                                            ...
                                            TextSpan(
                                              text: valueOrDefault<String>(
                                                getJsonField(
                                                  FFAppState()
                                                      .verifyOtpResponse,
                                                  r'''$.response.profile_info.account_info.account_number''',
                                                )?.toString(),
                                                'NA',
                                              ),
                                            ...
                                            TextSpan(
                                              text: valueOrDefault<String>(
                                                getJsonField(
                                                  FFAppState()
                                                      .verifyOtpResponse,
                                                  r'''$.response.profile_info.account_info.ifsc_code''',
                                                )?.toString(),
                                                'NA',
                                              ),
                                              style: const TextStyle(),
                                            ...
                                            TextSpan(
                                              text: valueOrDefault<String>(
                                                getJsonField(
                                                  FFAppState()
                                                      .verifyOtpResponse,
                                                  r'''$.response.profile_info.account_info.pan''',
                                                )?.toString(),
                                                'NA',
                                              ),
                                              style: const TextStyle(),
                                            ...
                                            TextSpan(
                                              text: valueOrDefault<String>(
                                                getJsonField(
                                                  FFAppState()
                                                      .verifyOtpResponse,
                                                  r'''$.response.profile_info.account_info.aadhar''',
                                                )?.toString(),
                                                'NA',
                                              ),
                                              style: const TextStyle(),
